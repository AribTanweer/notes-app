        ...
        <Fragment>
            ...
            <main className="flex gap-3">
                ...
                <div className="flex flex-col flex-1 mt-7">
                    <div className="flex flex-col w-[450px] border-black-400 relative self-center">
                        <input id="note-title" name="title" value={title} onChange={onTitleChange}
                            className="border border-neutral-800 rounded-t-md focus:outline-none border-b-0 p-1"
                            placeholder="Enter title" />
                        <textarea id="note-text" name="h-[100px] text" value={text} onChange={onTextChange}
